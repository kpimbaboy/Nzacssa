...
var gridpak = {
    ...
    bootstrap: function() {
        ...
        // Have they brought a knife to gunfight? (yeah i like movies)
        if (typeof(window.jQuery) == 'undefined') {
            script = document.createElement('script');
            script.src= jquerySrc;
            // Insert it after opening body tag
    ...
    /**
     * Make our cols and set up resizing functions :D
     */
    init: function() {
        var gridOn = false,
            grids = [
     ...
     /**
      * Toggles the grids visibility with a keypress 32 aka spacebar
      */
     toggleGrid: function() {
        var that = this;
